...
@implementation JMNavbarMenuItem
...
static NSInteger rowHeight = 48;
static CGFloat titleFontSize = 15.0;

@interface JMNavbarMenu ()
...
- (void)layoutSubviews {
    ...
    [self.items enumerateObjectsUsingBlock:^(JMNavbarMenuItem *obj, NSUInteger idx, BOOL *stop) {
