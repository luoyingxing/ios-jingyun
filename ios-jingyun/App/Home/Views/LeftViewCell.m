...
- (instancetype) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.imageOne = [[UIImageView alloc] initWithFrame:CGRectMake(10, 6, imageWidth, imageHeight)];
        [self addSubview:self.imageOne];
        
        self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageWidth + 10 + 8, 6, cellWidth - 20 - imageWidth - 8, imageHeight / 2)];
        ...
        self.sourceLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageWidth + 10 + 8, 6 + imageHeight / 2, cellWidth - 20 - imageWidth - 8, imageHeight / 2)];
